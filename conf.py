...
BLOG_AUTHOR = "JáquerEspeis"  # (translatable)
BLOG_TITLE = "JáquerEspeis"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jaquerespeis.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "jaquerespeis@googlegroups.com"
...
# (translatable)
CONTENT_FOOTER = '{license} - Creado con <a href="https://getnikola.com" rel="nofollow">Nikola</a>'
